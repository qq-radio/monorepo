...
const schemas: FormSchema[] = [
  ...
  },
  {
    ...
    customRender: () => {
      ...
      return (
        <BasicCheckboxGroup
          modelValue={model.value.coffee}
          options={options}
          onUpdate:modelValue={(value) => (model.value.coffee = value)}
        />
      );
    },
  },
  {
    ...
    customRender: () => {
      ...
      return (
        <BasicSelect
          modelValue={model.value.sport}
          options={options}
          onUpdate:modelValue={(value) => (model.value.sport = value)}
        />
      );
    },
  },
